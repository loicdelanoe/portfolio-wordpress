        ...
        <section class="contact">
            ...
            <form action="<?= esc_url(admin_url('admin-post.php')); ?>" class="form" method="post">
                <div class="field__container" data-animation="show-up">
                    ...
                    <input class="field__input" type="text" name="lastname" id="lastname" placeholder="Doe" value="<?= $_SESSION['old']['lastname'] ?? ''?>">
                ...
                <div class="field__container" data-animation="show-up">
                    ...
                    <input class="field__input" type="text" name="name" id="name" placeholder="John" value="<?= $_SESSION['old']['name'] ?? ''?>">
                ...
                <div class="field__container" data-animation="show-up">
                    ...
                    <input class="field__input" type="email" name="email" id="email" placeholder="john@doe.com" value="<?= $_SESSION['old']['email'] ?? '' ?>">
                ...
                <div class="field__container" data-animation="show-up">
                    ...
                    <input class="field__input" type="tel" name="phone" id="phone" placeholder="06 89 78 67 45" value="<?= $_SESSION['old']['phone'] ?? '' ?>">
