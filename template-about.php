...
<?php get_header() ?>
    <main>
        ...
        <section class="tools">
            <h2 class="tools__title" data-animation="show-up"><span>Mes</span> Outils</h2>
        ...
        <section class="approachs">
            <h2 class="approachs__title"><span>Mon</span>Approche</h2>
            <ul class="approachs__container">
                <li class="approachs__item approachs__item--design approach">
                    <div class="approach__container">
                        <h3 class="approach__title">Design</h3>
                        <p class="approach__content">Il est important de fournir un design complet et soigné aux clients afin qu’ils aient une bonne
                            idée de ce que leur site va donner quand il sera déployé.</p>
                    </div>
                </li>
                <li class="approachs__item approachs__item--dev approach">
                    <div class="approach__container">
                        <h3 class="approach__title">Développement</h3>
                        <p class="approach__content">Après le design, le développement est tout aussi important, mais surtout le respect des normes / conventions des langages (sémantique en HTML).</p>
                    </div>
                </li>
                <li class="approachs__item approachs__item--access approach">
                    <div class="approach__container">
                        <h3 class="approach__title">Accessibilité</h3>
                        <p class="approach__content">L’accessibilité d’un site web est cruciale, en effet n’importe quel site internet doit être pensé aussi pour les personnes en situation de handicap.</p>
                    </div>
                </li>
            </ul>
        </section>
        <section class="talk">
            <h2>Discutons :)</h2>
            <a class="cta" href="/contact">Contactez-moi</a>
        </section>
    </main>
<?php get_footer() ?>